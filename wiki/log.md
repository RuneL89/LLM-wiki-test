...
**Summary**: Append-only record of all operations performed on this wiki.
...
- **Action**: Initialize wiki
- **Details**: Created `raw/`, `wiki/`, `wiki/index.md`, and `wiki/log.md`

- **Action**: Ingest source
- **Source**: Rekins_949553846121.pdf
- **Details**: Created 11 wiki pages from the bill:
  - `rekins-949553846121.md` — bill summary
  - `as-latvenergo.md` — provider
  - `elektrum-ekonomiskais.md` — electricity plan
  - `elektrum-dabasgaze-virtuvei.md` — gas plan
  - `electricity-pricing-latvia.md` — electricity pricing structure
  - `gas-pricing-latvia.md` — gas pricing structure
  - `capacity-fee.md` — capacity fee concept
  - `single-zone-tariff.md` — single-zone tariff concept
  - `vat-energy-latvia.md` — VAT rules
